...
<body style="margin: 0; padding: 24px; font-family: 'Segoe UI', system-ui, sans-serif; background: linear-gradient(135deg, #f5f7fa 0%, #e4e8ec 100%); min-height: 100vh; box-sizing: border-box;">
    <div style="max-width: 480px; margin: 0 auto;">
        <h1 style="margin: 0 0 24px 0; font-size: 1.75rem; font-weight: 700; color: #1a1a2e;">Create Product</h1>

        <form action="{{ route('products.store') }}" method="POST" style="background: #fff; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border: 1px solid rgba(0,0,0,0.06);">
            @csrf
            ...
            <div style="display: flex; gap: 12px;">
                <button type="submit" style="padding: 10px 20px; font-size: 1rem; font-weight: 600; color: #fff; background: #1a1a2e; border: none; border-radius: 8px; cursor: pointer;">Save</button>
